...
+(void)initialize {
    ...
    int jsonBrokerErrorCode = [CAErrorCodeUtilities getBaseErrorCode:@"jsonbroker"];
...
#pragma mark -
#pragma mark <CALoggable> implementation 
...
-(NSArray*)getLogMessages {
    ...
    NSString* atosCommand = [CAExceptionHelper getAtosCommand:self];
