...
#import "CAGethostbyaddrRequest.h"
#import "CAGethostbyaddrRequestIntegrationTest.h"
#import "CALog.h"


@implementation CAGethostbyaddrRequestIntegrationTest
...
-(uint32_t)getByte:(int)byteNumber fromAddress:(CAIPAddress*)ipAddress {
...
-(void)testLocalhostByName {
	...
	CAIPAddress* ipAddress = [[CAIPAddress alloc] init];
	CAGethostbyaddrRequest* gethostbyaddrRequest = [[CAGethostbyaddrRequest alloc] initWithDnsName:@"localhost" ipAddress:ipAddress];
...
-(void)testLocalhostByAddress {
	...
	CAIPAddress* ipAddress = [[CAIPAddress alloc] init];	
	CAGethostbyaddrRequest* gethostbyaddrRequest = [[CAGethostbyaddrRequest alloc] initWithDnsName:@"127.0.0.1" ipAddress:ipAddress];
	[gethostbyaddrRequest asyncExecute];
...
-(void)testBigHostByAddress {
	...
	CAIPAddress* ipAddress = [[CAIPAddress alloc] init];	
	CAGethostbyaddrRequest* gethostbyaddrRequest = [[CAGethostbyaddrRequest alloc] initWithDnsName:@"255.1.2.3" ipAddress:ipAddress];
	[gethostbyaddrRequest asyncExecute];
...
-(void)testEtcHosts {
	...
	CAIPAddress* ipAddress = [[CAIPAddress alloc] init];	
	CAGethostbyaddrRequest* gethostbyaddrRequest = [[CAGethostbyaddrRequest alloc] initWithDnsName:@"hal.vmnet8" ipAddress:ipAddress];
	[gethostbyaddrRequest asyncExecute];
