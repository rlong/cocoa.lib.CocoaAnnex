...
@implementation CAIPAddress


+(CAIPAddress*)localhost {
	
	
	CAIPAddress* answer = [[CAIPAddress alloc] initWithAddress:loopbackIp4Address];
...
-(CAJsonArray*)toJSONArray {
	...
	CAJsonArray* answer = [[CAJsonArray alloc] initWithCapacity:4];
