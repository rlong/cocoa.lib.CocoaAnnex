...
@interface CAGethostbyaddrRequest () 
...
@implementation CAGethostbyaddrRequest
...
-(void)execute {
	...
	@finally {
		...
		long elapsedTime = [CATimeUtilities getElapsedTimeSince:&start];
