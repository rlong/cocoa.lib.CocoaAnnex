...
@implementation CAJsonStringHandler


static CAJsonStringHandler* _instance = nil;
static bool _doNotEscapeForwardSlashForOldRemoteGateway = false;

+(void)initialize {
	
	_instance = [[CAJsonStringHandler alloc] init];
...
-(id)readValue:(CAJsonInput*)reader { 
    ...
    return [CAJsonStringHandler readString:reader];
...
-(void)writeValue:(id)value writer:(id<CAJsonOutput>)writer {
    ...
    [CAJsonStringHandler writeString:(NSString*)value writer:writer];
