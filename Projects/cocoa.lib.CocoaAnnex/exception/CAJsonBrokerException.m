...
#import "CAJsonBrokerException.h"

@implementation CAJsonBrokerException
...
-(id)initWithOriginator:(id)originatingObject line:(int)line faultStringFormat:(NSString *)faultStringFormat, ... {
    ...
    CAJsonBrokerException* answer = [self initWithOriginator:originator faultMessage:technicalError];
