...
-(void)flushElementText {
    ...
    if( _trim ) {
        ...
        string = [CAStringHelper trim:string];
    }
...
- (void)parser:(NSXMLParser *)parser foundCDATA:(NSData *)CDATABlock {
    ...
    NSString* cDataText = [CADataHelper toUtf8String:CDATABlock];
...
- (void)parser:(NSXMLParser *)parser parseErrorOccurred:(NSError *)parseError {
    ...
    @throw [CABaseException baseExceptionWithOriginator:self line:__LINE__ callTo:@"[NSXMLParser parse]" failedWithError:parseError];
...
-(id)initWithJsonHandler:(id<CAJsonDocumentHandler>)jsonHandler {
    ...
    CASaxHandler* answer = [super init];
